...
function startCkeditor(id){
	...
	var editor = CKEDITOR.replace(
		id,
		{
			filebrowserBrowseUrl : '/adminlte/plugins/ckfinder/ckfinder.html',
			filebrowserImageBrowseUrl : '/adminlte/plugins/ckfinder/ckfinder.html?type=Images',
			filebrowserFlashBrowseUrl : '/adminlte/plugins/ckfinder/ckfinder.html?type=Flash',
			filebrowserUploadUrl : '/adminlte/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
			filebrowserImageUploadUrl : '/adminlte/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
			filebrowserFlashUploadUrl : '/adminlte/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash',
			toolbar : [
...
function popup(content){
	$('body').append('<div class="popup"><div class="popup-contener"><div class="popup-content"><a href="#" class="popup-close" onclick="return popupClose()"><span class="glyphicon glyphicon-remove"></span></a>'+content+'</div></div></div>')
	$('.popup').fadeIn(300);
}
